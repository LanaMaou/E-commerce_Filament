                    ...
                    <tbody>
                        @foreach ($order_items as $item)
                            <tr wire:key="{{ $item->id }}">
                                ...
                                <td class="py-4">{{ Number::currency($item->unit_amount, 'IDR', locale: 'id') }}</td>
                                <td class="py-4">
                                    <span class="w-8 text-center">{{ $item->quantity }}</span>
                                </td>
                                <td class="py-4">{{ Number::currency($item->total_amount, 'IDR', locale: 'id') }}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="md:w-1/4">
            <div class="p-6 bg-white rounded-lg shadow-md">
                ...
                <div class="flex justify-between mb-2">
                    <span>Subtotal</span>
                    <span>{{ Number::currency($order->grand_total, 'IDR', locale: 'id') }}</span>
                </div>
                <div class="flex justify-between mb-2">
                    <span>Taxes</span>
                ...
                <div class="flex justify-between mb-2">
                    ...
                    <span
                        class="font-semibold">{{ Number::currency($order->grand_total, 'IDR', locale: 'id') }}</span>
                </div>
